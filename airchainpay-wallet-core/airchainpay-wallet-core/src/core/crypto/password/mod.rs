...
impl PasswordManager {
    ...
    pub async fn hash_password(&self, password: &str) -> Result<String, WalletError> {
        ...
        let salt = argon2::password_hash::SaltString::generate(&mut os_rng);
